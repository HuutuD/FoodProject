package com.example.foodprojectapp.ChefFoodPanel.ChefAdapter;
...
public class ChefPreparedOrderViewAdapter extends RecyclerView.Adapter<ChefPreparedOrderViewAdapter.ViewHolder> {
    ...
    private final List<ChefFinalOrders> chefFinalOrderslist;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.price.setText("Price: VND " + chefFinalOrders.getDishPrice());
        holder.quantity.setText("× " + chefFinalOrders.getDishQuantity());
        holder.totalprice.setText("Total: VND " + chefFinalOrders.getTotalPrice());
    }
