    ...
    private void sendverificationcode(String number) {
        PhoneAuthProvider.verifyPhoneNumber(
                PhoneAuthOptions.newBuilder(FirebaseAuth.getInstance())
                        ...
                        .setActivity(CustomerPhoneSendOTP.this) // Activity
                        .setCallbacks(new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            @Override
                            public void onCodeSent(String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                super.onCodeSent(s, forceResendingToken);
                                Toast.makeText(CustomerPhoneSendOTP.this, "Code sent", Toast.LENGTH_SHORT).show();
                                verificationId = s;
                            }

                            @Override
                            public void onVerificationCompleted(PhoneAuthCredential phoneAuthCredential) {
                                Toast.makeText(CustomerPhoneSendOTP.this, "Verification completed", Toast.LENGTH_SHORT).show();
                            ...
                            public void onVerificationFailed(FirebaseException e) {
                                Toast.makeText(CustomerPhoneSendOTP.this, "Verification failed: " + e.getMessage(), Toast.LENGTH_LONG).show();
                            }
